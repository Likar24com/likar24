...
export default function PatientCabinet() {
  ...
  const confirmReschedule = async() => {
    ...
    setAppointments(xs=>
      xs.map(a=> a.id===rescheduleApp.id
    ...
    <main style={{ maxWidth:1000, margin:'2rem auto', fontFamily:'Arial, sans-serif' }}>
      ...
      <div style={{
        ...
        <button onClick={handleSignOut}
          style={{
            padding:'8px 16px', backgroundColor:'#e00',
      ...
      <div style={{ display:'flex', gap:20, alignItems:'flex-start' }}>
        ...
        {/* контент: приперемиканні просто ховаємо/показуємо, але контейнер завжди лишається */}
        <article style={{ flex:1, minHeight:600 }}>
          {/* «Мої дані» */}
